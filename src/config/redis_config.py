...
class RedisTemplate:
    ...
    def __init__(self):
        ...
        self.co_occurrence = redis.ConnectionPool.from_url(url=REDIS_URL + "/0")
        self.job_search_pool = redis.ConnectionPool.from_url(url=REDIS_URL + "/1")
        self.job_keyword_pool = redis.ConnectionPool.from_url(url=REDIS_URL + "/2")
        self.standard_word_pool = redis.ConnectionPool.from_url(url=REDIS_URL + "/3")
        self.standard_category_pool = redis.ConnectionPool.from_url(url=REDIS_URL + "/4")
